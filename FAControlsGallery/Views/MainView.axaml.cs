...
public partial class MainView : UserControl
{
    ...
    protected override void OnAttachedToVisualTree(VisualTreeAttachmentEventArgs e)
    {
        ...
        // Simple check - all desktop versions of this app will have a window as the TopLevel Mobile and WASM will have
        // something else
    ...
    {
        // Change the current selected item back to normal SetNVIIcon(sender as NavigationViewItem, false);

        if (e.InvokedItemContainer is NavigationViewItem nvi)
        {
            NavigationTransitionInfo info;

            // Keep the frame navigation when not using connected animation but suppress it if we have a connected
            // animation binding two pages
    ...
    {
        // Technically, yes you could set up binding and converters and whatnot to let the icon change between filled
        // and unfilled based on selection, but this is so much simpler
